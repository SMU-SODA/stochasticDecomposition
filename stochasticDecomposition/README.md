...
#### Steps
  ...
  5. Execute the algorithm. The input options for the algorithm are:  
     ...
     * Example: `-p pgp2 -i ../../spAlgorithms/spAlgorithms/spInput/ -o ../../spAlgorithms/spAlgorithms/spOutput -e 0 -d 1 -t l -m 0 -c 0`  

-p pgp2 -i /root/sultan/spAlgorithms/spAlgorithms/spInput -o /root/sultan/spAlgorithms/spAlgorithms/spOutput -e 0 -d 1 -t l -m 0 -c 0
